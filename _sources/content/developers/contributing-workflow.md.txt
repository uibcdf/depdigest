...
This page defines the default workflow for contributing code or documentation to DepDigest.
...
DepDigest is used as infrastructure in other libraries. Treat behavior changes conservatively:
