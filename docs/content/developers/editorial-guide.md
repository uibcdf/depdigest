...
This guide defines how we write documentation and contributor-facing text in DepDigest.
...
When a behavior is contractual, link the canonical source (for example `DEPDIGEST_GUIDE.md`) and avoid conflicting paraphrases.
